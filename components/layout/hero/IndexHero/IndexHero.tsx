    ...
    return (
        <>
            <Container>
                ...
                <Pitch>
                    Stonk Bot is one of the best tools to instantly be up to
                    date on all of your NYSE and crypto needs. We focus only on
                    the user, and you can be sure that the data you are seeing
                    is accurate.
                </Pitch>
            </Container>
        </>
